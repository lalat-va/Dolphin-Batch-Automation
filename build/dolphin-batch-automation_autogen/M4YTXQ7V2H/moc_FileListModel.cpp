...
template <> constexpr inline auto FileListModel::qt_create_metaobjectdata<qt_meta_tag_ZN13FileListModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'setPipelineAt'
        QtMocHelpers::MethodData<void(int, const QString &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::QString, 4 },
        }}),
        // Method 'appendPipelineAt'
        QtMocHelpers::MethodData<void(int, const QString &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::QString, 6 },
        }}),
        // Method 'setSelectedAt'
...
void FileListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->setPipelineAt((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->appendPipelineAt((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 2: _t->setSelectedAt((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 3: _t->setAllSelected((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 4: { QStringList _r = _t->selectedFilePaths();
